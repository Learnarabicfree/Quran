...
const shareMessages = {
    ...
    'Sinhala': {
        message: "කුර්ආනික ඥානය\n\n📖 කුර්ආනයේ අරාබි භාෂාව ඉගෙන ගෙන අල්ලාහ්ගේ වචනය කෙලින්ම තේරුම් ගෙන ඔහුට සමීප වෙමු. 🕔\n\n🔗 දැන් එකතු වන්න: ",
        subject: "📖 පැය 6 ට අඩු කාලයකින් මූලික කුර්ආනික අරාබි ඉගෙන ගන්න! 🕔",
        copied: "Link copied to clipboard!"
    },
    'Tamil': {
        message: "குர்ஆனிக ஞானம்\n\n6 குர்ஆனின் அரபி மொழியை படித்து அல்லாஹுத்தஆலாவின் வசனங்களை நேரடியாக விளங்கி அவனின் நெருக்கத்தைப் பெற்றுக் கொள்வோம். 🕔\n\n🔗 இப்போது சேரவும்: ",
